    ...
    <div className="min-h-screen flex flex-col bg-[#F0F4F8] relative overflow-hidden">
      ...
      <main className="flex-grow flex flex-col items-center justify-center text-center px-4 -mt-20 z-10">
        ...
        <div className="flex flex-col items-center gap-6">
          <button className="bg-[#0D5C4A] hover:bg-[#084839] text-white px-10 py-5 rounded-full font-bold text-lg shadow-2xl transition-all hover:scale-105 active:scale-95 flex items-center gap-3">
